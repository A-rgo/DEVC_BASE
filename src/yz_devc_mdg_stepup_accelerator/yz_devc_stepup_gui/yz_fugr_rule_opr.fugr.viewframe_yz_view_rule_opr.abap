*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YZ_VIEW_RULE_OPR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YZ_VIEW_RULE_OPR    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_OPR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YZ_VIEW_RULE_OPR_EXTRACT
TOTAL = YZ_VIEW_RULE_OPR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_OPR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YZ_VIEW_RULE_OPR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YZ_VIEW_RULE_OPR_EXTRACT
TOTAL = YZ_VIEW_RULE_OPR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YZ_VIEW_RULE_OPR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_OPR'
...
TOTAL = YZ_VIEW_RULE_OPR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YZ_VIEW_RULE_OPR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YZ_VIEW_RULE_OPR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_OPR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YZ_VIEW_RULE_OPR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YZ_VIEW_RULE_OPR_EXTRACT
TOTAL = YZ_VIEW_RULE_OPR_TOTAL

*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YZ_VIEW_RULE_TAS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YZ_VIEW_RULE_TAS    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_TAS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YZ_VIEW_RULE_TAS_EXTRACT
TOTAL = YZ_VIEW_RULE_TAS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_TAS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YZ_VIEW_RULE_TAS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YZ_VIEW_RULE_TAS_EXTRACT
TOTAL = YZ_VIEW_RULE_TAS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YZ_VIEW_RULE_TAS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_TAS'
...
TOTAL = YZ_VIEW_RULE_TAS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YZ_VIEW_RULE_TAS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YZ_VIEW_RULE_TAS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_TAS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YZ_VIEW_RULE_TAS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YZ_VIEW_RULE_TAS_EXTRACT
TOTAL = YZ_VIEW_RULE_TAS_TOTAL

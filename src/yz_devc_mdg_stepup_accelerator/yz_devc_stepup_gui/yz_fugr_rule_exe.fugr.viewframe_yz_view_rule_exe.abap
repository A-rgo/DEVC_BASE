*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YZ_VIEW_RULE_EXE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YZ_VIEW_RULE_EXE    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_EXE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YZ_VIEW_RULE_EXE_EXTRACT
TOTAL = YZ_VIEW_RULE_EXE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_EXE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YZ_VIEW_RULE_EXE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YZ_VIEW_RULE_EXE_EXTRACT
TOTAL = YZ_VIEW_RULE_EXE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YZ_VIEW_RULE_EXE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_EXE'
...
TOTAL = YZ_VIEW_RULE_EXE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YZ_VIEW_RULE_EXE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YZ_VIEW_RULE_EXE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_EXE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YZ_VIEW_RULE_EXE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YZ_VIEW_RULE_EXE_EXTRACT
TOTAL = YZ_VIEW_RULE_EXE_TOTAL

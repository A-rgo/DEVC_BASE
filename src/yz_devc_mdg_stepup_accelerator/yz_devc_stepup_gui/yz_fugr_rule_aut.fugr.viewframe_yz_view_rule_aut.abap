*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YZ_VIEW_RULE_AUT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YZ_VIEW_RULE_AUT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_AUT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YZ_VIEW_RULE_AUT_EXTRACT
TOTAL = YZ_VIEW_RULE_AUT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_AUT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YZ_VIEW_RULE_AUT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YZ_VIEW_RULE_AUT_EXTRACT
TOTAL = YZ_VIEW_RULE_AUT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YZ_VIEW_RULE_AUT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_AUT'
...
TOTAL = YZ_VIEW_RULE_AUT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YZ_VIEW_RULE_AUT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YZ_VIEW_RULE_AUT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YZ_VIEW_RULE_AUT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YZ_VIEW_RULE_AUT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YZ_VIEW_RULE_AUT_EXTRACT
TOTAL = YZ_VIEW_RULE_AUT_TOTAL

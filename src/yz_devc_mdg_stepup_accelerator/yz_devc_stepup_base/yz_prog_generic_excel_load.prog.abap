*&---------------------------------------------------------------------*
*& Report YZ_PROG_GENERIC_EXCEL_LOAD
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT YZ_PROG_GENERIC_EXCEL_LOAD NO STANDARD PAGE HEADING..
*&---------------------------------------------------------------------*
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
        ...
        IF ls_excel-row = 1.
          ...
          IF sy-subrc = 0.
            IF ls_table_fields-fieldname NE ls_excel-value.
              WRITE: 'Excel sheet field names and Dynamic table field names are not matching or not in same order'.
              EXIT.
            ENDIF.
          ENDIF.
        ELSE.

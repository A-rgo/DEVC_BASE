*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMREF_REQ_METDTA
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMREF_REQ_METDTA    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMREF_REQ_METDTA'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMREF_REQ_METDTA_EXTRACT
TOTAL = ZMREF_REQ_METDTA_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMREF_REQ_METDTA'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMREF_REQ_METDTA-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMREF_REQ_METDTA_EXTRACT
TOTAL = ZMREF_REQ_METDTA_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMREF_REQ_METDTA-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMREF_REQ_METDTA'
...
TOTAL = ZMREF_REQ_METDTA_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMREF_REQ_METDTA-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMREF_REQ_METDTA-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMREF_REQ_METDTA'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMREF_REQ_METDTA-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMREF_REQ_METDTA_EXTRACT
TOTAL = ZMREF_REQ_METDTA_TOTAL

*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMREF_MSTR_AGENT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMREF_MSTR_AGENT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMREF_MSTR_AGENT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMREF_MSTR_AGENT_EXTRACT
TOTAL = ZMREF_MSTR_AGENT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMREF_MSTR_AGENT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMREF_MSTR_AGENT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMREF_MSTR_AGENT_EXTRACT
TOTAL = ZMREF_MSTR_AGENT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMREF_MSTR_AGENT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMREF_MSTR_AGENT'
...
TOTAL = ZMREF_MSTR_AGENT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMREF_MSTR_AGENT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMREF_MSTR_AGENT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMREF_MSTR_AGENT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMREF_MSTR_AGENT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMREF_MSTR_AGENT_EXTRACT
TOTAL = ZMREF_MSTR_AGENT_TOTAL

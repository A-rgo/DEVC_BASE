*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMREF_OBJ_CLASS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMREF_OBJ_CLASS     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMREF_OBJ_CLASS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMREF_OBJ_CLASS_EXTRACT
TOTAL = ZMREF_OBJ_CLASS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMREF_OBJ_CLASS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMREF_OBJ_CLASS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMREF_OBJ_CLASS_EXTRACT
TOTAL = ZMREF_OBJ_CLASS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMREF_OBJ_CLASS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMREF_OBJ_CLASS'
...
TOTAL = ZMREF_OBJ_CLASS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMREF_OBJ_CLASS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMREF_OBJ_CLASS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMREF_OBJ_CLASS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMREF_OBJ_CLASS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMREF_OBJ_CLASS_EXTRACT
TOTAL = ZMREF_OBJ_CLASS_TOTAL

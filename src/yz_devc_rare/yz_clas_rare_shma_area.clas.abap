class YZ_CLAS_RARE_SHMA_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'YZ_CLAS_RARE_SHMA_AREA' ##NO_TEXT.
  data ROOT type ref to YZ_CLAS_RARE_SHMA_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to YZ_CLAS_RARE_SHMA_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to YZ_CLAS_RARE_SHMA_ROOT
    raising
...
CLASS YZ_CLAS_RARE_SHMA_AREA IMPLEMENTATION.

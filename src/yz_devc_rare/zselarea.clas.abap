...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZSELAREA' ##NO_TEXT.
  data ROOT type ref to ZCL_SELSCR read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZSELAREA
    raising
      CX_SHM_INCONSISTENT

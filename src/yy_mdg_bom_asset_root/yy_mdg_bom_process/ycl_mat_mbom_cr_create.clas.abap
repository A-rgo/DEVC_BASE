class YCL_MAT_MBOM_CR_CREATE definition
  public
  final
  create public .
...
CLASS YCL_MAT_MBOM_CR_CREATE IMPLEMENTATION.
...
* Copies the object list and most of the CR data
  CONSTANTS:
    gc_crtype               TYPE usmd_crequest_type VALUE'YBMAT02'. " 'YBMAT02'. "Change Request type for the new change request (material change)
  DATA:
...
* Clear exporting parameter
  ...
  CASE iv_service_name.
    WHEN 'YMAT_MBOM'." 'insert your service name (as defined via IMG) here'.
